    ...
    <div style={{ width: '100%' }}>
      <div className="page-header">
        <div>
          <div>
            <div>
              <h1>{'Buy Bitcoin with Neteller'}</h1>

              <p>
                {
                  'With CoinGate, you can purchase Bitcoin, Ether, Litecoin and Altcoins with your Neteller wallet instantly. No registration, instant payment confirmation, payout within 24 hours!'
                }
              </p>
            </div>
          </div>
          ...
          <div>
            <div>
              <ExpressCheckout gateway="neteller" />

              <img
                src="https://static.coingate.com/images/logo/Neteller.svg"
      ...
      <div className="steps">
        <div>
          ...
          <div>
            <div>{'3'}</div>
            <h3>{'Complete the instant Neteller payment'}</h3>
          </div>
          <div>
            <div>{'4'}</div>
      ...
      <div className="benefits-of-neteller">
        <div>
          <h2>{'The benefits of buying crypto with Neteller'}</h2>
